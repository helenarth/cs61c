...
public class Proj1 {
    ...
    public static class Map1 extends Mapper<WritableComparable, Text, Text, NumPair> {
		...
		throws IOException, InterruptedException {
			...
			double distanceTwoGram = Double.MAX_VALUE;
		...
		parse:
			...
			//for (int b = 0; b < gramList.size(); b++) {
				//for (int z = 0; z < targetGramNumSet.size(); z++) {
					//System.out.println(gramList.get(b) + " == " +targetGram.toString() + 
					//				   "---- " + (((String)gramList.get(b)).compareTo(targetGram.toString()) == 0));
					if (((String)gramList.get(b)).equals(targetGram.toString())) {//issue here
						System.out.println("it worked  \n " );
						continue;
					}
					else {
					System.out.println("targetGramNumSet is: " + targetGramNumSet.get(z) + " \n");
					...
					//newDistance = func.f(distanceTwoGram);
					//context.write(new Text(gramList.get(z)), new NumPair(newDistance,1.0));
				}
				distanceTwoGram = Double.MAX_VALUE;
			}
