...
/* HACK: so error would manifest itself (cause a segfault) on hive machines.
 * Previously this lab was done on the Sutardja Dai machines, which
 * had an allocator much less tolerant of misuses of free() */
